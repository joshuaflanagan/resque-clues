        ...
        def self.define_perform(klass) # :doc:
          klass.send(:define_method, :_clues_perform) do
            if Clues.configured? and payload['clues_metadata']
              ...
              Clues::Runtime.expose_metadata_to_job payload['clues_metadata']
              _base_perform.tap do
                ...
                Clues::Runtime.store_changes_from_job(payload['clues_metadata'])
            ...
            _base_fail(exception).tap do
              ...
              if Clues.configured? and metadata
                ...
                metadata['_backtrace'] =
                  metadata['backtrace'] =
                    exception.backtrace
                Clues::Runtime.store_changes_from_job(metadata)
